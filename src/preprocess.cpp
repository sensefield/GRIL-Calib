...
void Preprocess::process_cut_frame_livox(const livox_ros_driver2::msg::CustomMsg::UniquePtr &msg,
...
void Preprocess::velodyne_handler_nclt(const sensor_msgs::msg::PointCloud2::UniquePtr &msg) {
